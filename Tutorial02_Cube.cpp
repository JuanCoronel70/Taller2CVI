...
void Tutorial02_Cube::CreateVertexBuffer()
{
    ...
    constexpr Vertex CubeVerts[6] =
        {
            // Vértice superior
            {float3{0, +1, 0}, float4{0, 0, 1, 1}}, // (Vértice 0)

            // Vértices en el plano medio
            {float3{-1, 0, -1}, float4{1, 0, 0, 1}}, // (Vértice 1)
            {float3{+1, 0, -1}, float4{1, 0, 0, 1}}, // (Vértice 2)
            {float3{+1, 0, +1}, float4{1, 0, 0, 1}}, // (Vértice 3)
            {float3{-1, 0, +1}, float4{1, 0, 0, 1}}, // (Vértice 4)

            // Vértice inferior
            {float3{0, -1, 0}, float4{0, 0, 1, 1}} // Violeta (Vértice 5)
...
void Tutorial02_Cube::CreateIndexBuffer()
{
    ...
    {
        // Explicación: 4, 0, 3 significa que se forma un triángulo con los vértices 4, 0 y 3.
            // 4, 3, 2 significa que se forma otro triángulo con los vértices 4, 3 y 2.
            
        // Pirámide superior
        0, 1, 2,  // Triángulo 1: Vértices 0, 1, 2
        0, 2, 3,  // Triángulo 2: Vértices 0, 2, 3
        0, 3, 4,  // Triángulo 3: Vértices 0, 3, 4
        0, 4, 1,  // Triángulo 4: Vértices 0, 4, 1

        // Pirámide inferior
        5, 2, 1,  // Triángulo 5: Vértices 5, 2, 1
        5, 3, 2,  // Triángulo 6: Vértices 5, 3, 2
        5, 4, 3,  // Triángulo 7: Vértices 5, 4, 3
        5, 1, 4,   // Triángulo 8: Vértices 5, 1, 4
