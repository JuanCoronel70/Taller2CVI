...
void Tutorial02_Cube::CreateVertexBuffer()
{
    ...
    constexpr Vertex CubeVerts[10] =
        {
            // Vértices superiores
            {float3{-0.5, 1, -0.5}, float4{1, 0, 0, 1}}, // 0
            {float3{0.5, 1, -0.5}, float4{0, 1, 0, 1}},  // 1
            {float3{0.7, 1, 0.3}, float4{0, 0, 1, 1}},   // 2
            {float3{0.0, 1, 0.7}, float4{1, 1, 0, 1}},   // 3
            {float3{-0.7, 1, 0.3}, float4{0, 1, 1, 1}},  // 4

            // Vertices inferiores
            {float3{-0.5, -1, -0.5}, float4{1, 0, 1, 1}},      // 5
            {float3{0.5, -1, -0.5}, float4{0.5, 0.5, 0, 1}},   // 6
            {float3{0.7, -1, 0.3}, float4{0, 0.5, 0.5, 1}},    // 7
            {float3{0.0, -1, 0.7}, float4{0.5, 0, 0.5, 1}},    // 8
            {float3{-0.7, -1, 0.3}, float4{0.5, 0.5, 0.5, 1}}, // 9
